...
def main(page: ft.Page):
    ...
    #Imagen Logo
    img = ft.Image(
        src="https://lh6.googleusercontent.com/LPa8dqqKrI0PuNV5PfVXOK-mZeXKsyLcItQ312AqIlYqz_HzNzIH9zUF_dV7L8qzy_kxYKSbVAV5oXfbJ2_UzygYJXbhfKdVqVlwgRuOKK0i3tEvhmK-5hYoP1miT-Vxgg=w1280",
        width=300,
        height=300,
